...
so this could cause some issues with the boundary layer thickness, which would afffect the velocity at the step, and thereby the solution. Should rectify this

4/11/25
So, in addition to the above, I've also realised that numerical optimization in general is quite involved (who could've known). So, I'll probably first try it out in another repo, and then come back to this
UPDATE - I've tried out an airfoil optimizer, and I think I have a better grasp of the subject matter now.